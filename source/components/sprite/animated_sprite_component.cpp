...
AnimatedSpriteComponent::AnimatedSpriteComponent(game_objects::wp_game_object_t owner, const components::sprite::sprite_draw_order_t draw_oder, const float _anim_fps) :
